...
__GateOr function
	   ...
	   ; Converting into floats here below 
...
__main  function		 
	   ...
	   ; I am printing the output and calling the Printmsg in the gates function itself
	   
	   ; The below is the codes for printing the truth table for checking the output
	   
	   
	   ;Priniting NOT gate truth table
	   MOV r0,#0
	   BL printGate
	   ...
	   ;Priniting AND gate truth table
	   MOV r0,#1
	   BL printGate
	   ...
	   ;Priniting NAND gate truth table
	   MOV r0,#3
	   BL printGate
	   ...
	   ;Priniting NOR gate truth table
	   MOV r0,#4
	   BL printGate
	   ...
	   ;Priniting XOR gate truth table
	   MOV r0,#5
	   BL printGate
	   ...
	   ;Priniting XNOR gate truth table
	   MOV r0,#6
	   BL printGate
